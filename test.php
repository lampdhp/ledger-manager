...
<?php
			...
			/*echo '<div id="box-1" class="hidden-box hidden-loc-index">
					<ul>
						<li align="center" style="height:30px;" >修改密码</li>
						<li align="center" style="height:30px;" >退出登录</li>
					</ul>
				</div>';*/		
			...
			/*1号锅炉
			$sql11="select * from sys where jizu=1 and mainsys=1";
			$res11 = $sqlHelper->execute_dql($sql11);			
			$row11_cnt=$res11->num_rows ;			
			$height11=($row11_cnt/4+2)*50;*/
			for($j=1;$j<=6;$j++){
				for($m=1;$m<=6;$m++){
							...
							<li>
								...
								<ul class='dl-submenu' style='width:1000px; height:";print($height[1][1]);echo"px;'>";
									while ( $row11  =  $res[1][1] -> fetch_row ()) {
										 echo  "<li style='float:left; width:25%;'><a href='equipment.php?sys=$row11[0]' target='contentFrame'>";
										 echo $row11 [ 1 ];
										 echo "</a></li>";
							...
							<li>
								...
								<ul class='dl-submenu' style='width:1000px; height:";print($height[1][2]);echo"px;'>";
									while ( $row12  =  $res[1][2] -> fetch_row ()) {
										 echo  "<li style='float:left; width:25%;'><a href='equipment.php?sys=$row12[0]' target='contentFrame'>";
										 echo $row12 [ 1 ];
										 echo "</a></li>";
							...
							<li>
								...
								<ul class='dl-submenu' style='width:1000px; height:";print($height[1][3]);echo"px;'>";
									while ( $row13  =  $res[1][3] -> fetch_row ()) {
										 echo  "<li style='float:left; width:25%;'><a href='equipment.php?sys=$row13[0]' target='contentFrame'>";
										 echo $row13 [ 1 ];
										 echo "</a></li>";
							...
							<li>
								...
								<ul class='dl-submenu' style='width:1000px; height:";print($height[1][4]);echo"px;'>";
									while ( $row14  =  $res[1][4] -> fetch_row ()) {
										 echo  "<li style='float:left; width:25%;'><a href='equipment.php?sys=$row14[0]' target='contentFrame'>";
										 echo $row14 [ 1 ];
										 echo "</a></li>";
							...
							<li>
								...
								<ul class='dl-submenu' style='width:1000px; height:";print($height[1][5]);echo"px;'>";
									while ( $row15  =  $res[1][5] -> fetch_row ()) {
										 echo  "<li style='float:left; width:25%;'><a href='equipment.php?sys=$row15[0]' target='contentFrame'>";
										 echo $row15 [ 1 ];
										 echo "</a></li>";
							...
							<li>
								...
								<ul class='dl-submenu' style='width:1000px; height:";print($height[1][6]);echo"px;'>";
									while ( $row16  =  $res[1][6] -> fetch_row ()) {
										 echo  "<li style='float:left; width:25%;'><a href='equipment.php?sys=$row16[0]' target='contentFrame'>";
										 echo $row16 [ 1 ];
										 echo "</a></li>";
							...
							<li>
								...
								<ul class='dl-submenu' style='width:1000px; height:";print($height[2][1]);echo"px;'>";
									while ( $row21  =  $res[2][1] -> fetch_row ()) {
										 echo  "<li style='float:left; width:25%;'><a href='equipment.php?sys=$row21[0]' target='contentFrame'>";
										 echo $row21 [ 1 ];
										 echo "</a></li>";
							...
							<li>
								...
								<ul class='dl-submenu' style='width:1000px; height:";print($height[2][2]);echo"px;'>";
									while ( $row22  =  $res[2][2] -> fetch_row ()) {
										 echo  "<li style='float:left; width:25%;'><a href='equipment.php?sys=$row22[0]' target='contentFrame'>";
										 echo $row22 [ 1 ];
										 echo "</a></li>";
							...
							<li>
								...
								<ul class='dl-submenu' style='width:1000px; height:";print($height[2][3]);echo"px;'>";
									while ( $row23  =  $res[2][3] -> fetch_row ()) {
										 echo  "<li style='float:left; width:25%;'><a href='equipment.php?sys=$row23[0]' target='contentFrame'>";
										 echo $row23 [ 1 ];
										 echo "</a></li>";
							...
							<li>
								...
								<ul class='dl-submenu' style='width:1000px; height:";print($height[2][4]);echo"px;'>";
									while ( $row24  =  $res[2][4] -> fetch_row ()) {
										 echo  "<li style='float:left; width:25%;'><a href='equipment.php?sys=$row24[0]' target='contentFrame'>";
										 echo $row24 [ 1 ];
										 echo "</a></li>";
							...
							<li>
								...
								<ul class='dl-submenu' style='width:1000px; height:";print($height[2][5]);echo"px;'>";
									while ( $row25  =  $res[2][5] -> fetch_row ()) {
										 echo  "<li style='float:left; width:25%;'><a href='equipment.php?sys=$row25[0]' target='contentFrame'>";
										 echo $row25 [ 1 ];
										 echo "</a></li>";
							...
							<li>
								...
								<ul class='dl-submenu' style='width:1000px; height:";print($height[2][6]);echo"px;'>";
									while ( $row26  =  $res[2][6] -> fetch_row ()) {
										 echo  "<li style='float:left; width:25%;'><a href='equipment.php?sys=$row26[0]' target='contentFrame'>";
										 echo $row26 [ 1 ];
										 echo "</a></li>";
							...
							<li>
								...
								<ul class='dl-submenu' style='width:1000px; height:";print($height[3][1]);echo"px;'>";
									while ( $row31  =  $res[3][1] -> fetch_row ()) {
										 echo  "<li style='float:left; width:25%;'><a href='equipment.php?sys=$row31[0]' target='contentFrame'>";
										 echo $row31 [ 1 ];
										 echo "</a></li>";
							...
							<li>
								...
								<ul class='dl-submenu' style='width:1000px; height:";print($height[3][2]);echo"px;'>";
									while ( $row32  =  $res[3][2] -> fetch_row ()) {
										 echo  "<li style='float:left; width:25%;'><a href='equipment.php?sys=$row32[0]' target='contentFrame'>";
										 echo $row32 [ 1 ];
										 echo "</a></li>";
							...
							<li>
								...
								<ul class='dl-submenu' style='width:1000px; height:";print($height[3][3]);echo"px;'>";
									while ( $row33  =  $res[3][3] -> fetch_row ()) {
										 echo  "<li style='float:left; width:25%;'><a href='equipment.php?sys=$row33[0]' target='contentFrame'>";
										 echo $row33 [ 1 ];
										 echo "</a></li>";
							...
							<li>
								...
								<ul class='dl-submenu' style='width:1000px; height:";print($height[3][4]);echo"px;'>";
									while ( $row34  =  $res[3][4] -> fetch_row ()) {
										 echo  "<li style='float:left; width:25%;'><a href='equipment.php?sys=$row34[0]' target='contentFrame'>";
										 echo $row34 [ 1 ];
										 echo "</a></li>";
							...
							<li>
								...
								<ul class='dl-submenu' style='width:1000px; height:";print($height[3][5]);echo"px;'>";
									while ( $row35  =  $res[3][5] -> fetch_row ()) {
										 echo  "<li style='float:left; width:25%;'><a href='equipment.php?sys=$row35[0]' target='contentFrame'>";
										 echo $row35 [ 1 ];
										 echo "</a></li>";
							...
							<li>
								...
								<ul class='dl-submenu' style='width:1000px; height:";print($height[3][6]);echo"px;'>";
									while ( $row36  =  $res[3][6] -> fetch_row ()) {
										 echo  "<li style='float:left; width:25%;'><a href='equipment.php?sys=$row36[0]' target='contentFrame'>";
										 echo $row36 [ 1 ];
										 echo "</a></li>";
							...
							<li>
								...
								<ul class='dl-submenu' style='width:1000px; height:";print($height[4][1]);echo"px;'>";
									while ( $row41  =  $res[4][1] -> fetch_row ()) {
										 echo  "<li style='float:left; width:25%;'><a href='equipment.php?sys=$row41[0]' target='contentFrame'>";
										 echo $row41 [ 1 ];
										 echo "</a></li>";
							...
							<li>
								...
								<ul class='dl-submenu' style='width:1000px; height:";print($height[4][2]);echo"px;'>";
									while ( $row42  =  $res[4][2] -> fetch_row ()) {
										 echo  "<li style='float:left; width:25%;'><a href='equipment.php?sys=$row42[0]' target='contentFrame'>";
										 echo $row42 [ 1 ];
										 echo "</a></li>";
							...
							<li>
								...
								<ul class='dl-submenu' style='width:1000px; height:";print($height[4][3]);echo"px;'>";
									while ( $row43  =  $res[4][3] -> fetch_row ()) {
										 echo  "<li style='float:left; width:25%;'><a href='equipment.php?sys=$row43[0]' target='contentFrame'>";
										 echo $row43 [ 1 ];
										 echo "</a></li>";
							...
							<li>
								...
								<ul class='dl-submenu' style='width:1000px; height:";print($height[4][4]);echo"px;'>";
									while ( $row44  =  $res[4][4] -> fetch_row ()) {
										 echo  "<li style='float:left; width:25%;'><a href='equipment.php?sys=$row44[0]' target='contentFrame'>";
										 echo $row44 [ 1 ];
										 echo "</a></li>";
							...
							<li>
								...
								<ul class='dl-submenu' style='width:1000px; height:";print($height[4][5]);echo"px;'>";
									while ( $row45  =  $res[4][5] -> fetch_row ()) {
										 echo  "<li style='float:left; width:25%;'><a href='equipment.php?sys=$row45[0]' target='contentFrame'>";
										 echo $row45 [ 1 ];
										 echo "</a></li>";
							...
							<li>
								...
								<ul class='dl-submenu' style='width:1000px; height:";print($height[4][6]);echo"px;'>";
									while ( $row46  =  $res[4][6] -> fetch_row ()) {
										 echo  "<li style='float:left; width:25%;'><a href='equipment.php?sys=$row46[0]' target='contentFrame'>";
										 echo $row46 [ 1 ];
										 echo "</a></li>";
							...
							<li>
								...
								<ul class='dl-submenu' style='width:1000px; height:";print($height[5][1]);echo"px;'>";
									while ( $row51  =  $res[5][1] -> fetch_row ()) {
										 echo  "<li style='float:left; width:25%;'><a href='equipment.php?sys=$row51[0]' target='contentFrame'>";
										 echo $row51 [ 1 ];
										 echo "</a></li>";
							...
							<li>
								...
								<ul class='dl-submenu' style='width:1000px; height:";print($height[5][2]);echo"px;'>";
									while ( $row52  =  $res[5][2] -> fetch_row ()) {
										 echo  "<li style='float:left; width:25%;'><a href='equipment.php?sys=$row52[0]' target='contentFrame'>";
										 echo $row52 [ 1 ];
										 echo "</a></li>";
							...
							<li>
								...
								<ul class='dl-submenu' style='width:1000px; height:";print($height[5][3]);echo"px;'>";
									while ( $row53  =  $res[5][3] -> fetch_row ()) {
										 echo  "<li style='float:left; width:25%;'><a href='equipment.php?sys=$row53[0]' target='contentFrame'>";
										 echo $row53 [ 1 ];
										 echo "</a></li>";
							...
							<li>
								...
								<ul class='dl-submenu' style='width:1000px; height:";print($height[5][4]);echo"px;'>";
									while ( $row54  =  $res[5][4] -> fetch_row ()) {
										 echo  "<li style='float:left; width:25%;'><a href='equipment.php?sys=$row54[0]' target='contentFrame'>";
										 echo $row54 [ 1 ];
										 echo "</a></li>";
							...
							<li>
								...
								<ul class='dl-submenu' style='width:1000px; height:";print($height[5][5]);echo"px;'>";
									while ( $row55  =  $res[5][5] -> fetch_row ()) {
										 echo  "<li style='float:left; width:25%;'><a href='equipment.php?sys=$row55[0]' target='contentFrame'>";
										 echo $row55 [ 1 ];
										 echo "</a></li>";
							...
							<li>
								...
								<ul class='dl-submenu' style='width:1000px; height:";print($height[5][6]);echo"px;'>";
									while ( $row56  =  $res[5][6] -> fetch_row ()) {
										 echo  "<li style='float:left; width:25%;'><a href='equipment.php?sys=$row56[0]' target='contentFrame'>";
										 echo $row56 [ 1 ];
										 echo "</a></li>";
							...
							<li>
								...
								<ul class='dl-submenu' style='width:1000px; height:";print($height[6][1]);echo"px;'>";
									while ( $row61  =  $res[6][1] -> fetch_row ()) {
										 echo  "<li style='float:left; width:25%;'><a href='equipment.php?sys=$row61[0]' target='contentFrame'>";
										 echo $row61 [ 1 ];
										 echo "</a></li>";
							...
							<li>
								...
								<ul class='dl-submenu' style='width:1000px; height:";print($height[6][2]);echo"px;'>";
									while ( $row62  =  $res[6][2] -> fetch_row ()) {
										 echo  "<li style='float:left; width:25%;'><a href='equipment.php?sys=$row62[0]' target='contentFrame'>";
										 echo $row62 [ 1 ];
										 echo "</a></li>";
							...
							<li>
								...
								<ul class='dl-submenu' style='width:1000px; height:";print($height[6][3]);echo"px;'>";
									while ( $row63  =  $res[6][3] -> fetch_row ()) {
										 echo  "<li style='float:left; width:25%;'><a href='equipment.php?sys=$row63[0]' target='contentFrame'>";
										 echo $row63 [ 1 ];
										 echo "</a></li>";
							...
							<li>
								...
								<ul class='dl-submenu' style='width:1000px; height:";print($height[6][4]);echo"px;'>";
									while ( $row64  =  $res[6][4] -> fetch_row ()) {
										 echo  "<li style='float:left; width:25%;'><a href='equipment.php?sys=$row64[0]' target='contentFrame'>";
										 echo $row64 [ 1 ];
										 echo "</a></li>";
							...
							<li>
								...
								<ul class='dl-submenu' style='width:1000px; height:";print($height[6][5]);echo"px;'>";
									while ( $row65  =  $res[6][5] -> fetch_row ()) {
										 echo  "<li style='float:left; width:25%;'><a href='equipment.php?sys=$row65[0]' target='contentFrame'>";
										 echo $row65 [ 1 ];
										 echo "</a></li>";
							...
							<li>
								...
								<ul class='dl-submenu' style='width:1000px; height:";print($height[6][6]);echo"px;'>";
									while ( $row66  =  $res[6][6] -> fetch_row ()) {
										 echo  "<li style='float:left; width:25%;'><a href='equipment.php?sys=$row66[0]' target='contentFrame'>";
										 echo $row66 [ 1 ];
										 echo "</a></li>";
							...
							<li>
								...
								<ul class='dl-submenu' style='width:1000px; height:";print($height[7][7]);echo"px;'>";
									while ( $row77  =  $res[7][7] -> fetch_row ()) {
										 echo  "<li style='float:left; width:25%;'><a href='equipment.php?sys=$row77[0]' target='contentFrame'>";
										 echo $row77 [ 1 ];
										 echo "</a></li>";
							...
							<li>
								...
								<ul class='dl-submenu' style='width:1000px; height:";print($height[7][8]);echo"px;'>";
									while ( $row78  =  $res[7][8] -> fetch_row ()) {
										 echo  "<li style='float:left; width:25%;'><a href='equipment.php?sys=$row78[0]' target='contentFrame'>";
										 echo $row78 [ 1 ];
										 echo "</a></li>";
							...
							<li>
								...
								<ul class='dl-submenu' style='width:1000px; height:";print($height[7][9]);echo"px;'>";
									while ( $row79  =  $res[7][9] -> fetch_row ()) {
										 echo  "<li style='float:left; width:25%;'><a href='equipment.php?sys=$row79[0]' target='contentFrame'>";
										 echo $row79 [ 1 ];
										 echo "</a></li>";
