...
<?php
	...
	checkUserValidate();
	//session_start();
	//if(empty($_SESSION['tznum'])|| $_SESSION['tzgrade']==1)
	//{
	...
	while ( $row  =  $res -> fetch_row ()) {
         echo  "<td><a href=content2.php?eid=$row[0]>";
		 echo $row [ 1 ];
		 echo "</a></td>";
		 if($i%5==0)
		 {
	...
	echo "<td align='center'><a class='editEquip'>设备管理..</a></td></tr></table>";
