			...
			$.ajax({
				...
				success:function(json){
					...
					if(total==0){
						...
						$.each(list,function(index,array){ //遍历json数据列
							tr += "<tr><td align='center'>"+j+"</td><td align='center'>"+array['name']+"</td><td align='center'>"+array['tuhao']+"</td><td align='center'>"+array['cgtime']+"</td><td align='center'>"+array['xorh']+"</td><td align='center'>"+array['litime']+"</td><td align='center'>"+array['reason']+"</td></tr>";
							j++;						
						});
					}
			...
			$.ajax({
				...
				success:function(json){
					...
					if(total==0){
						...
						$.each(list,function(index,array){ //遍历json数据列
							tr += "<tr><td align='center'>"+j+"</td><td align='center'>"+array['dxtime']+"</td><td align='center'>"+array['jilu']+"</td><td align='center'><a href='dxjl/"+array['file_name']+"' download='"+array['file_name']+"'>下载</a></td></tr>";
							j++;						
						});
					}
			...
			$.ajax({
				...
				success:function(json){
					...
					if(total==0){
						...
						$.each(list,function(index,array){ //遍历json数据列
							tr += "<tr><td align='center' width='200'>"+k+"</td><td align='center'><a href='jszl/"+array['file_name']+"' download='"+array['file_name']+"'>"+array['file_name']+"</a></td></tr>"; 
							k++;						
						});
					}
			...
			$.ajax({
				...
				success:function(json){
					...
					if(total==0){
						...
						$.each(list,function(index,array){ //遍历json数据列
							tr += "<tr><td align='center' width='200'>"+y+"</td><td align='center'>"+array['num']+"</td><td align='center'>"+array['name']+"</td><td align='center'>"+array['profile']+"</td><td align='center'><a href='yidongdan/"+array['file_name']+"' download='"+array['file_name']+"'>下载</a></td></tr>";  
							y++;						
						});
					}
			...
			$.ajax({
				...
				success:function(json){
					...
					if(total==0){
						...
						$.each(list,function(index,array){ //遍历json数据列
							tr += "<tr><td align='center' width='200'>"+m+"</td><td align='center'>"+array['name']+"</td><td align='center'>"+array['mntime']+"</td><td align='center'><a href='monidan/"+array['file_name']+"' download='"+array['file_name']+"'>下载</a></td></tr>";  
							m++;						
						});
					}
